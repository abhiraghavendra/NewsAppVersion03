...
public class topStories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(topStories.this, MainActivity.class));
            }
        });
        ...
        final1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(topStories.this, Audio_activity.class));
            }
        });
    ...
    {
        ProgressDialog progressDialog = new ProgressDialog(topStories.this);
        ...
        protected Exception doInBackground(Integer... params) {
            ...
            try
            {
                URL url = new URL("https://news.google.com/news/rss/?ned=in&gl=IN&hl=en-IN");
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(topStories.this, android.R.layout.simple_list_item_1, smallTitleList);
