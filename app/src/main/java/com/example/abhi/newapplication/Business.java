...
public class Business extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Business.this, MainActivity.class));
            }
        });
        ...
        final1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Business.this, Audio_activity.class));
            }
        });
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception>
    {
        ...
        protected Exception doInBackground(Integer... params) {
            ...
            try
            {
                URL url = new URL("https://news.google.com/news/rss/headlines/section/topic/BUSINESS?ned=in&hl=en-IN&gl=IN");
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(Business.this, android.R.layout.simple_list_item_1, smallTitleList);
