...
public class sports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(sports.this, MainActivity.class));
            }
        });
        ...
        new sports.ProcessInBackground().execute();
    }
    ...
    {
        ProgressDialog progressDialog = new ProgressDialog(sports.this);
        ...
        protected Exception doInBackground(Integer... params) {
            ...
            try
            {
                URL url = new URL("https://news.google.com/news/headlines/section/topic/SPORTS?ned=in&hl=en-IN&gl=IN");
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(sports.this, android.R.layout.simple_list_item_1, smallTitleList);
