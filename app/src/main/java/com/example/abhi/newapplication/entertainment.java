...
public class entertainment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(entertainment.this, Audio_activity.class));
            }
        });
        ...
        new entertainment.ProcessInBackground().execute();
    }
    ...
    {
        ProgressDialog progressDialog = new ProgressDialog(entertainment.this);
        ...
        protected Exception doInBackground(Integer... params) {
            ...
            try
            {
                URL url = new URL("https://news.google.com/news/rss/headlines/section/topic/ENTERTAINMENT?ned=in&hl=en-IN&gl=IN");
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(entertainment.this, android.R.layout.simple_list_item_1, smallTitleList);
